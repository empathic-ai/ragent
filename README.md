...
# Ragent
A Rust-based framework for agents--capable of handling real-time, multimodal, multi-agent interactions with maximal performance in the cloud, on the web and on embedded devices.
