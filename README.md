...
# Ragent
A Rust-based framework for agents--designed for real-time, multimodal, multi-agent workflows with maximal performance in the cloud, on the web and on embedded devices.
